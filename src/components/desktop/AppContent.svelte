...
<style>
	...
	.os-guide { margin: 0; padding: 0; list-style: none; }
	.os-guide li { display: grid; grid-template-columns: 2rem 1fr; gap: 0.5rem; padding: 0.72rem 0; border-top: 1px solid #d5d0c6; }
	.os-guide li > span { color: #938d82; font-size: 0.59rem; }
	.os-guide strong { font-family: var(--font-sans); font-size: 0.83rem; }
	.os-guide p { margin: 0.15rem 0 0; color: #777269; font-size: 0.68rem; }
	...
	@media (max-width: 760px) {
		...
		.profile-pane, .welcome-pane, .page-app { padding: 1.35rem; }
